...
const baseVariantClasses = {
	...
	secondary: "bg-gray-100 dark:bg-neutral-700 text-gray-800 dark:text-gray-200",
	danger: "bg-red-600 text-white",
	warning: "bg-yellow-600 text-white",
	info: "bg-blue-600 text-white",
	ghost: "bg-transparent text-gray-700 dark:text-gray-300",
	soft: "bg-gray-100 dark:bg-neutral-900 text-gray-700 dark:text-gray-300",
	"outline-primary": "border-2 border-neutral-900 dark:border-white text-neutral-900 dark:text-white bg-transparent",
	"outline-secondary": "border-2 border-gray-400 dark:border-neutral-500 text-gray-700 dark:text-gray-300 bg-transparent",
	"outline-danger": "border-2 border-red-600 dark:border-red-500 text-red-600 dark:text-red-500 bg-transparent"
};
...
function Button({
	...
	const variantClass = hover ? `${baseVariantClasses[variant]} ${hoverClasses[hover]}` : variantClasses[variant];
