				...
				<div
					...
					<div className="mt-6 flex flex-wrap justify-end gap-3">
						...
						<button
							...
							onClick={onConfirm}
							disabled={isLoading}
							className={`px-4 py-2 ${config.buttonBg} ${config.buttonText} rounded-md transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2`}>
