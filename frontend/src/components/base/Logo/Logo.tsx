...
function Logo({ size = "md", className = "", clickable = true }: LogoProps) {
	...
	const baseClasses =
		"select-none leading-none font-light tracking-wider uppercase bg-neutral-700 dark:bg-white text-transparent bg-clip-text drop-shadow-[0_1px_1px_rgba(0,0,0,0.35)]";
