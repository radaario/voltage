...
export const config = {
	...
	utils: {
		...
		ffmpeg: {
			...
			bit_rate_min: getEnvNumberOrNull("VOLTAGE_UTILS_FFMPEG_BIT_RATE_MIN", null), // e.g., in bps
			bit_rate_max: getEnvNumberOrNull("VOLTAGE_UTILS_FFMPEG_BIT_RATE_MAX", null) // e.g., in bps
		},
		nsfw: {
	...
	// Jobs configuration
	jobs: {
		queue_timeout: getEnvNumberOrNull("VOLTAGE_JOBS_QUEUE_TIMEOUT", 5 * 60 * 1000), // 5 minutes, null to disable
